...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><img src="{{ asset('imagens/MuximaReports.png')  }}" style="width: 100%"></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                {{-- <small>MembersinceNov.2012</small> --}}
                </p>
              </li>
              <!-- Menu Body -->
              {{--<li class="user-body">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> V1</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>V2</a></li>
          </ul>
        </li>
...
{{--        <!-- Left col -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="https://adminlte.io">Angoteisg</a>.</strong> Todos os direitos reservados
  </footer>
